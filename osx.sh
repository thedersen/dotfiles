...
sudo scutil --set ComputerName "tpe-book"
sudo scutil --set HostName "tpe-book"
sudo scutil --set LocalHostName "tpe-book"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "tpe-book"
